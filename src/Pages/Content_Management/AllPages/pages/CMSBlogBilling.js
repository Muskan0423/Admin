...
const Action = ({ blog_id }) => {
  ...
  const handleClick = async () => {
    ...
    Navigate('/home/editblogBilling', { state: data })
  };
...
const CMSBlogBiling = ({ setActiveTab, setExpand }) => {
  setExpand("contentManagement");
  setActiveTab("blogs");
  const head = "Blogs for Billing";
  ...
  const greenClicked = () => {
    navigate("/home/addblogforBilling");
  };
