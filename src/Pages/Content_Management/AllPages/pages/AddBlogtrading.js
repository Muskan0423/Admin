...
import { addNewBlog_cms, addNewBlog_cms_trading, editContactPage_cms, updateUser } from "../../../User_Management/features/userSlice";
...
const AddBlogtrading = ({ setActiveTab, setExpand }) => {

  setActiveTab("blogs");
  setExpand("contentManagement")
  const head = "Add Blog  for Trading";
  ...
  const handleSubmit = async (event) => {
   ...
   if(metaphoto) formData.append("banner_image", metaphoto)
    ...
    setLoading(true);
    await dispatch(addNewBlog_cms_trading(formData));
    setLoading(false);
