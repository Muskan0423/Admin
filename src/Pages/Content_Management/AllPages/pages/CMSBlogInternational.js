...
const Action = ({ blog_id }) => {
  ...
  const handleClick = async () => {
    ...
    Navigate('/home/editblogInternational', { state: data })
  };
...
const CMSBlogInternational = ({ setActiveTab, setExpand }) => {
  setExpand("contentManagement");
  setActiveTab("blogs");
  const head = "Blogs for International";
  ...
  const handleClick = (data) => {
    navigate('/home/editblogSewa', { state: data })
  };
  const greenClicked = () => {
    navigate("/home/editblogInternational");
  };
...
export default CMSBlogInternational;
